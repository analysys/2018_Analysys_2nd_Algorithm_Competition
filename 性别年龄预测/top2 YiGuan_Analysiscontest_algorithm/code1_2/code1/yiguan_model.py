...
print('-' * 80)
with timer('deviceid_packages LDA'):
...
# deviceid_packages【APP信息不全，如何处理？】
# APP 个数
# 最常见的APP类型
# 1896072db9ce6406febfc17f681c2086 微信
# 2338f5519ae89cb819360870c849ac62 淘宝
# 1cd8e0a97bf3552196f0f60eb3566ac7 支付宝
# de54c4c46133bd8e06c5e2de6a38e846 京东
# 78e04abe2a3643fca2d629b441182ec5 滴滴
# ba912ebcbc1e09fe0eca046298b1771e 今日头条
# 2c94bf3242575e85879b036c109b39ea 美图秀秀
# 4df74dfb9d9fc3b7aad62d9dfa73204f ofo/摩拜
id_app['app_len'] = id_app['app'].apply(lambda x: len(x))

# deviceid_brand
# 用户的手机品牌、价格、出产年份、手机颜色
# 手机是否为女性手机?
# 手机是否为智能机?
# 手机是否为功能机?
# 手机是否为游戏机?
...
# deviceid_time
# 用户使用手机的习惯
# 用户24小时内打开手机的次数、打开APP的个数、使用手机的时间比例、使用手机的小时比例
# 打开手机的间隔、打开APP的间隔

# 使用时间最长的APP类型、打开次数最多的APP类型、
# APP类型的ngram特征、APP ngram特征
# 将APPembedding，直接对用户进行分类
print('Done.')
